...
from iso15434 import Iso15434, FieldCustomerPartNumber, FieldSupplierPartNumber, FieldQuantity, FieldDateCode1, FieldLotCode, FieldCountryOfOrigin, FieldManufacturer


class Iso15434TestCase(unittest.TestCase):
  def test_speccase(self):
    input = "[)>\u241e06\u241dP596-777A1-ND\u241d1PXAF4444\u241dQ3\u241d10D1452\u241d1TBF1103\u241d4LUS\u241e\u2404"
    parsed = Iso15434.from_data(input)
